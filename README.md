...
1. Download the .app from [jenkins](http://jenkins.imagej.net/view/LOCI/job/GitHubBackup/)
2. (optional) Drag the downloaded .app to your Applications folder
3. Run GitHubBackup.app
...
The GitHubBackup project also creates an executable jar. To get the executable jar you can download the latest stable version from [jenkins](http://jenkins.imagej.net/view/LOCI/job/GitHubBackup/).
